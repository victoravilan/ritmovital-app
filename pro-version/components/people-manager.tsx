...
export default function PeopleManager({ people, onPeopleChange, maxPeople = 3 }: PeopleManagerProps) {
          ...
          <Card className="bg-slate-700/50 border-slate-600">
            <CardContent className="p-4">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <Label htmlFor="birthPlace" className="text-white">Lugar de Nacimiento</Label>
                  <Input
                    id="birthPlace"
